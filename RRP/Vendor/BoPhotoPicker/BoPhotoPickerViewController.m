...
- (void)setupNavBar {
    ...
    navBar.backgroundColor = IWColor(250, 250, 250);
    ...
    [cancelBtn setTitleColor:IWColor(50, 50, 50) forState:UIControlStateNormal];
    ...
    titleLabel.textColor = IWColor(50, 50, 50);
    ...
    [okBtn setTitleColor:IWColor(50, 50, 50) forState:UIControlStateNormal];
