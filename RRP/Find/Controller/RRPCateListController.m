...
@interface RRPCateListController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation RRPCateListController
...
- (void)downLoadData:(refState)refState andPageNumber:(NSInteger)page
{
    ...
    [[NetWorkManager sharedManager] POST:FindRecreation parameters:dic success:^(AFHTTPRequestOperation * _Nonnull operation, id  _Nonnull responseObject) {
